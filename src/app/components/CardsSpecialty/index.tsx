    ...
    return(
        ...
        <div className="hero-overlay bg-gradient-to-tr from-rose-400 to-rose-950">
            ...
            <div className="max-w-screen-xl mx-auto px-4 text-center text-gray-600 md:px-8">
                ...
                <h1 className="text-4xl drop-shadow-lg text-gray-300 font-extrabold mx-auto md:text-5xl">
                Qual das especialidades você precisa de ajuda?          
            </h1>
                </div>
                <div className="mt-12">
                    <ul className="grid gap-y-6 gap-x-4 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            features.map((item, idx) => (
                                <a href="#" className="group rounded-xl ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-rose-950">
